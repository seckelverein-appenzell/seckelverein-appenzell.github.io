                  ...
                  <ul class="p-2 shadow menu dropdown-content z-[2] bg-base-100 rounded-box w-52 mt-4 border border-base-300">
                    ...
                    <li>
                      <a href="https://www.strava.com/clubs/1619291/posts/new" target="_blank" class="flex justify-between">
                        Neuer Post
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-4 h-4 opacity-40"><path stroke-linecap="round" stroke-linejoin="round" d="M13.5 6H5.25A2.25 2.25 0 0 0 3 8.25v10.5A2.25 2.25 0 0 0 18 18.75V10.5m-10.5 6L21 3m0 0h-5.25M21 3v5.25" /></svg>
                      </a>
                    </li>
                  </ul>
                </details>
